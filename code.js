...
const arrLeaders = [{
    "name": "15.2.14",
    "act": 'נועה יוצרת את הסרטון האגדי "הנה אני"'
  },
  {
    "name": "כנראה 2014",
    "act": "מדברת עם מרב דניאל זיו בטלפון של הבית בזמן שהיא מתקלחת כי האישה עסוקה"
  },
  {
    "name": "אוקטובר 2015",
    "act": 'נועה נשכבת על כביש באמצע שכונה בניו יורק רק כדי לחקות תמונה שלנון סטלה העלתה'
  },
  {
    "name": "מתישהו בתיכון",
    "act": "נועה נרדמת במהלך הקלטת וואטסאפ שהיא שלחה לליטל"
  },
  {
    "name": "22.8.19",
    "act": "נועה נוחתת בברלין (עיר של נאצים) עם מרב דניאל זיו ושירי"
  },
  {
    "name": "31.5.20",
    "act": "נועה ויובל כמעט לא חזרו בחיים מקניון הזהב"
  },
  {
    "name": "2.7.20",
    "act": 'נועה מנסה ללמוד את השיר "getting married today"'
  },
  {
    "name": "10.8.20",
    "act": "הסליפאובר הסאחי ביותר שלנו- עושות משחק שתייה עם סיידר ומים"
  },
  {
    "name": "24.9.20",
    "act": 'נועה מתעצבנת על צה"ל לראשונה באופן מתועד על זה שצריך להסתובב רק עם אוזנייה אחת'
  },
  {
    "name": "9.11.20",
    "act": 'נועה שוברת את הזרת בזמן המסע לעבר המקלחות בבסיס קריית ההדרכה על שם אריאל שרון שבנגב'
  },
  {
    "name": "17.3.21",
    "act": 'נועה טועמת גמבה ואננס לראשונה'
  },
  {
    "name": "29.3.21",
    "act": 'נועה מצהירה שהיא לא שותה קפה קר פחחחח'
  },
  {
    "name": "17.7.21",
    "act": "נועה מוצאת את עצמה שותה אריזונה ואוכלת וולט באחת בלילה עם מרב דניאל זיו וליטל כי כל הברים בדיזינגוף 24+"
  },
  {
    "name": "9.9.21",
    "act": "נועה ריגשה מעל 100 איש במצודה באיזור במופע חד פעמי סוחף ומרגש"
  },
  {
    "name": "17.10.21",
    "act": `מישהו מהבסיס של יובל התחיל איתה ביומולדת של חברה משותפת ואז גילה שהיא לסבית`
  }
];
